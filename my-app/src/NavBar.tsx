...
export default class NavBar extends Component {
    render(){
        return(
            <div id="main-div">
               <a href="####" >      <svg width="81" height="36" viewBox="0 0 81 36" fill="none" xmlns="http://www.w3.org/2000/svg"id="svg-details">
                   ...
                   <a href="####" className="color-icon"> <PublicIcon id="public-icon">
                    </PublicIcon></a>
                    <a href="####" className="color-icon"> <NotificationsIcon id="notification-icon"></NotificationsIcon></a>
                    <a href="####" className="color-icon">  <PeopleIcon id="people-icon"></PeopleIcon></a>
                    <a href="####" className="color-icon">  <AccountCircleIcon id="profile-icon"></AccountCircleIcon></a>
